...
Optional fields: `bucket` (bucketed layouts), `codexMeta` (from `agents/openai.yaml`), `dependsOnSkills` / `skillDependencies` (agents). See [Data model](/docs/data-model#artifact-scanned-not-persisted).
