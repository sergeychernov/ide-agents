...
Global and project are **mutually exclusive** in the UI — at most one active scope per artifact. A single installation is applied to **all enabled IDEs** when you toggle Global or Project.
